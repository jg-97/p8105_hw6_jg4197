...
According to the violin plot, we can see the best among three is the _bwt ~ bhead + blength + babysex + bhead * blength + bhead * babysex + blength * babysex + bhead * blength * babyse_ model which consider the interaction of the variables
